    ...
    for (uint i = 0; i < n_samples; i++)
      {
        ...
        if (freq_mod_in)
          mod_fc *= bse_approx3_exp2 (freq_mod_in[i] * freq_mod_octaves);
        ...
        if (OVERSAMPLE)
          {
            ...
            double values[4] = {
              values[0] = over_samples[0][over_pos],
              values[1] = over_samples[1][over_pos],
              values[2] = over_samples[0][over_pos + 1],
              values[3] = over_samples[1][over_pos + 1],
            };
